...
var transporter = nodemailer.createTransport({
  service: "hotmail",
  auth: {
    user: "Ghassen.klai@esprit-tn.com",
    pass: "T5albiza1@@",
  },
});
...
var mailOptions = {
  from: '"Esprit-Evaluation-System" <Ghassen.klai@esprit-tn.com>', // sender address
  to: "ghassen.klai@esprit.tn",
  cc: "ghassen.klai@esprit.tn", // list of receivers
  subject: "ratting Teachers!",
  html: templateVerify(), // the name of the template file i.e email.handlebars
  attachments: [
    {
      filename: "logoEmail.png",
      path: __dirname + "/logoEmail.png",
      cid: "espritlogos.ee",
    },
  ],
  context: {
...
exports.complaintMail = function (req, res, next) {
...
<head>
  ...
  <meta property="og:title" content="Esprit Evaluation System">
  <title>VEsprit Evaluation System</title>
  <style type="text/css">
    #outlook a{
        padding:0;
      }
                ...
                <table border="0" cellpadding="0" cellspacing="0" width="450" id="templateHeader" style="background-color:#FFFFFF;border-bottom:0;">
                  <tr>
                    <td class="headerContent centeredWithBackground" style="border-collapse:collapse;color:#202020;font-family:Arial;font-size:34px;font-weight:bold;line-height:100%;padding:0;text-align:center;vertical-align:middle;background-color:#F4EEE2;padding-bottom:20px;padding-top:20px;">
                      ...
                      <img width="130" src="cid:espritlogos.ee" id="headerImage campaign-icon">
                        ...
                        <tr>
                          <td valign="top" style="padding-bottom:1rem;border-collapse:collapse;" class="mainContainer">
                            <div style="text-align:center;color:#505050;font-family:Arial;font-size:14px;line-height:150%;">
                              <h1 class="h1" style="color:#a43334;display:block;font-family:Arial;font-size:24px;font-weight:bold;line-height:100%;margin-top:20px;margin-right:0;margin-bottom:20px;margin-left:0;text-align:center;">Esprit Evaluation System</h1>

                              <!-- <h2 class="h2">Heading 2</h2>
                                                                <h3 class="h3">Heading 3</h3>
                                                                <h4 class="h4">Heading 4</h4> -->
                              <p>This email for evaluating your teachers </p>
                            </div>
                          </td>
                        </tr>
                        <tr>
                  ...
                  <tr>
                    <td valign="top" class="footerContent" style="padding-left:0;border-collapse:collapse;background-color:#fafafa;">
                      <div style="text-align:center;color:#c9c9c9;font-family:Arial;font-size:11px;line-height:150%;">
                        <p style="text-align:left;margin:0;margin-top:2px;">Esprit Evaluation System | Tunisie, Ariana , 3200 | Copyright © 2021 | All rights reserved</p>
                      </div>
                      <!-- // End Module: Standard Footer \\ -->
                    </td>
                  </tr>
