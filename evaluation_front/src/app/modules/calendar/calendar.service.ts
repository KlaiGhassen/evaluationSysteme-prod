...
export class CalendarService {
    ...
    addCalendar(calendar: Calendar): Observable<Calendar> {
        return this.calendars$.pipe(
            ...
            switchMap((calendars) =>
                this._httpClient
                    .post<Calendar>('api/apps/calendar/calendars', {
                        calendar,
                    })
                    .pipe(
                        map((addedCalendar) => {
    ...
    updateCalendar(id: string, calendar: Calendar): Observable<Calendar> {
        return this.calendars$.pipe(
            ...
            switchMap((calendars) =>
                this._httpClient
                    .patch<Calendar>('api/apps/calendar/calendars', {
                        id,
                        calendar,
                    })
                    .pipe(
    ...
    deleteCalendar(id: string): Observable<any> {
        return this.calendars$.pipe(
            ...
            switchMap((calendars) =>
                this._httpClient
                    .delete<Calendar>('api/apps/calendar/calendars', {
                        params: { id },
                    })
                    .pipe(
                        map((isDeleted) => {
                            ...
                            const events = this._events.value.filter(
    ...
    getEvents(
        ...
        if (
            replace ||
            !this._loadedEventsRange.start ||
            start.isBefore(this._loadedEventsRange.start)
        ) {
        ...
        if (
            replace ||
            !this._loadedEventsRange.end ||
            end.isAfter(this._loadedEventsRange.end)
        ) {
        ...
        // Get the events
        return this._httpClient
            .get<CalendarEvent[]>(environment.apiUrl + 'seanceMangment', {
                params: {
    ...
    reloadEvents(): Observable<CalendarEvent[]> {
        // Get the events
        return this._httpClient
            .get<CalendarEvent[]>('api/apps/calendar/events', {
                params: {
    ...
    prefetchFutureEvents(end: Moment): Observable<CalendarEvent[]> {
        ...
        end = this._loadedEventsRange.end
            .clone()
            .add(this._numberOfDaysToPrefetch - remainingDays, 'days');
    ...
    prefetchPastEvents(start: Moment): Observable<CalendarEvent[]> {
        ...
        // Figure out the start and end dates
        start = this._loadedEventsRange.start
            .clone()
            .subtract(this._numberOfDaysToPrefetch - remainingDays, 'days');
    ...
    addEvent(event): Observable<CalendarEvent> {
        return this.events$.pipe(
            ...
            switchMap((events) =>
                this._httpClient
                    .post<CalendarEvent>('api/apps/calendar/event', {
                        event,
                    })
                    .pipe(
                        map((addedEvent) => {
    ...
    updateEvent(id: string, event): Observable<CalendarEvent> {
        return this.events$.pipe(
            ...
            switchMap((events) =>
                this._httpClient
                    .patch<CalendarEvent>('api/apps/calendar/event', {
                        id,
                        event,
                    })
                    .pipe(
    ...
    updateRecurringEvent(
        ...
        return this._httpClient.patch<boolean>(
            'api/apps/calendar/recurring-event',
            {
                event,
                originalEvent,
                mode,
    ...
    deleteEvent(id: string): Observable<CalendarEvent> {
        return this.events$.pipe(
            ...
            switchMap((events) =>
                this._httpClient
                    .delete<CalendarEvent>('api/apps/calendar/event', {
                        params: { id },
                    })
                    .pipe(
                        map((isDeleted) => {
    ...
    getSettings(): Observable<CalendarSettings> {
        return this._httpClient
            .get<CalendarSettings>('api/apps/calendar/settings')
            .pipe(
                tap((response) => {
    ...
    updateSettings(settings: CalendarSettings): Observable<CalendarSettings> {
        return this.events$.pipe(
            ...
            switchMap((events) =>
                this._httpClient
                    .patch<CalendarSettings>('api/apps/calendar/settings', {
                        settings,
                    })
                    .pipe(
                        map((updatedSettings) => {
    ...
    downloadQrCode(fileName: any): Observable<Blob> {
        return this._httpClient.get(
            environment.apiUrl + 'seanceMangment/qrcode/' + fileName,
            {
                responseType: 'blob',
            }
        );
    ...
    getWeekdays(): Observable<CalendarWeekday[]> {
        return this._httpClient
            .get<CalendarWeekday[]>('api/apps/calendar/weekdays')
            .pipe(
                tap((response) => {
    ...
    addPresence(data: any): Observable<any> {
        return this._httpClient.post<any>(
            environment.apiUrl + 'seanceMangment/presence',
            { data }
        );
    }

    downloadPdfQrCode(fileName: any): Observable<Blob> {
        return this._httpClient.get(
            environment.apiUrl + 'seanceMangment/pdf/' + fileName,
            {
                responseType: 'blob',
            }
        );
